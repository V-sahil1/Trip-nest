...
function ListRoom() {
  ...
  return (
    <div>
        ...
        <div
        className="w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80
            ...
            {rooms.map((item,index)=>(
                    <tr key={index}>
                        <td className='py-3 px-4 text-gray-700 border-t border-gray-300'>{item.roomType}</td>
                         ...
                         <td className='py-3 px-4 text-gray-700 border-t border-gray-300 max-sm:hidden'>₹{item.pricePerNight}</td>
                         <td className='py-3 px-4 text-red-500 border-t border-gray-300 text-center max-sm:hidden'>

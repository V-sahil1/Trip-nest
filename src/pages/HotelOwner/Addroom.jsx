...
accept='image/*' → Only allows image files. */}
            {/* If an image is selected, it shows a preview using
            URL.createObjectURL(image[key]). → If not, it shows a placeholder
            image (assets.uploadArea). */}
          </label>
        ))}
      </div>
